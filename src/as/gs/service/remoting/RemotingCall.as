package gs.service.remoting
{
	...
	public class RemotingCall
	{
		 ...
		 * 
		 * <ul>
		 * <li>onResult The on result callback.</li>
		 * <li>onFault The on fault callback.</li>
		 * <li>onTimeout The on timeout callback.</li>
		 * <li>onRetry The on retry callback.</li>
		 * <li>onFirstCall The on first call callback.</li>
		 * <li>onConnectFailed The callback for failed connections.</li>
		 * <li>onBadVersion The on bad version callback.</li>
		 * <li>onClosed The closed connection callback.</li>
		 * <li>onSecurityError The on security error callback.</li>
		 * <li>onIOError The on io error callback.</li>
		 * </ul>
		 * 
