package gs.core
{
	 ...
	 * 
	 * @eventType gs.support.preloading.events.AssetCompleteEvent
	 */
	[Event("assetComplete", type="gs.support.preloading.events.AssetCompleteEvent")]
	
	/**
	 * Dispatched for each asset that has started downloading.
	 * 
	 * @eventType gs.support.preloading.events.AssetOpenEvent
	 */
	[Event("assetOpen", type="gs.support.preloading.events.AssetOpenEvent")]
	
	/**
	 * Dispatched for each asset that has has stopped downloading because of an error.
	 * 
	 * @eventType gs.support.preloading.events.AssetErrorEvent
	 */
	[Event("assetError", type="gs.support.preloading.events.AssetErrorEvent")]
	 ...
	 * 
	 * @eventType gs.support.preloading.events.AssetStatusEvent
	 */
	[Event("assetStatus", type="gs.support.preloading.events.AssetStatusEvent")]
	
	/**
	 * Dispatched on progress of the entire Preloader progress.
	 * 
	 * @eventType gs.support.preloading.events.PreloadProgressEvent
	 */
	[Event("preloadProgress", type="gs.support.preloading.events.PreloadProgressEvent")]
